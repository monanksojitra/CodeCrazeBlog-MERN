  ...
  return (
    <>
      <div className="bg-white relative flex items-center  justify-center overflow-hidden z-50 ">
              ...
              <div className="lg:max-w-xl lg:pr-5 relative z-40">
                ...
                <div className="mt-10 flex flex-col items-center md:flex-row">
                  <a
                    ...
                    className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-600 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
                  >
                    View More
                  </a>
                  <a
        ...
        <div className="hidden text-9xl  absolute top-6 left-1/4 text-g/10 z-40    ">
          About Us
        </div>
