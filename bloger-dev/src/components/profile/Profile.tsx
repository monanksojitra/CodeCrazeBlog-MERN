                  ...
                  <div className="w-full lg:w-4/12 px-4  lg:order-3 lg:text-right lg:self-center">
                    <div className="pt-10  px-3 flex-col gap-2 sm:flex-row lg:pt-0 flex items-center justify-center">
                      <button onClick={() => setModelOpen(true)}
                        className="bg-blue-600  active:bg-blue-400 uppercase text-white font-bold hover:shadow-md shadow text-xs px-6 h-8 rounded outline-none focus:outline-none ease-linear transition-all duration-150"
                        type="button"
                      >
                        Edit Profile
                      </button>
                      <button
                        className=" border border-rounded border-red-500 hover:bg-red-500 hover:text-white uppercase text-red-500 font-bold hover:shadow-md shadow text-xs px-4 h-8 rounded ease-linear transition-all duration-150"
                        type="button"
                      >
                        Delete Profile
                      </button>
