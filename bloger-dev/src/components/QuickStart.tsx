const QuickStart = () => {
  return (
    <section>
      <div className="py-16 bg-white w-full dark:bg-gray-900">
        <div className="container mx-auto px-6 max-w-7xl text-gray-500">
          <div className="text-center">
            <h2 className="text-3xl text-black dark:text-white font-semibold">
              Quickstart with boilerplates
            </h2>
            <p className="mt-6 dark:text-gray-400 text-gray-500">
