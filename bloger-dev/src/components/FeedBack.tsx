  ...
  return (
    <section className=" mx-auto container bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        <div className="text-center pb-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-4">
          <svg
            className="mx-auto dark:fill-white fill-blue-600"
            width={48}
            height={42}
            viewBox="0 0 48 42"
            fill="none"
          ...
          <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-gray-900 dark:text-white py-6">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-5">
            <div className="flex items-center space-x-6 mb-4">
              ...
              />
              <div>
                <p className="text-xl text-gray-700 dark:text-gray-100 font-normal mb-1">
                  Dany Bailey
                </p>
                <p className="text-base text-blue-600 dark:text-slate-400 font-normal">
                  Software Engineer
                </p>
              </div>
            </div>
            <div>
              <p className="text-gray-400 dark:text-gray-100 leading-loose font-normal text-sm">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
