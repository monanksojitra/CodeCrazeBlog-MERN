...
const Contact = () => {
  return (
    <>
    {/* component */}
    <div className="py-4 dark:bg-gray-900 bg-white text-white">
      <div className="container mx-auto max-w-7xl flex flex-col md:flex-row my-12 md:my-36">
        <div className="flex flex-col w-full lg:w-2/5 p-8">
          <p className="text-3xl md:text-5xl dark:text-white text-black  font-bold my-4 leading-relaxed md:leading-snug">
            Contact our team
          </p>
          <p className="font-sans text-sm md:text-lg my-2 md:my-4">
            ...
            S.P Ring Road , Rajpath clube , Ahmedabad
          </p>
          <p className="font-sans text-sm md:text-lg my-2 md:my-4">
            <svg
              className="inline-block fill-current mr-2"
